                      ...
                      sidebarLayout(
                        sidebarPanel(width = 4,
                                     ...
                                     shinyWidgets::pickerInput("genre","Select or search for one or multiple genres",
                                                 choices =  unique(Spotify$Track_genre),selected = NULL,multiple = T),
                                     shiny::selectizeInput("feature_1", "Feature 1",choices =  colnames(Spotify)[10:20],  multiple = F),
                                     shiny::sliderInput("lev1", NULL, min = 0, max = 10, value = 0,ticks=F),
                                     shiny::selectizeInput("feature_2", "Feature 2", choices =  colnames(Spotify)[10:20],  multiple = F),
                                     shiny::sliderInput("lev2", NULL, min = 0, max = 10, value = 0,ticks=F),
                                     shiny::selectizeInput("feature_3", "Feature 3",choices =  colnames(Spotify)[10:20], multiple = F),
                                     shiny::sliderInput("lev3", NULL, min = 0, max = 10, value = 0,ticks=F),
                                     shiny::selectizeInput("feature_4", "Feature 4",choices =  colnames(Spotify)[10:20], multiple = F),
                                     shiny::sliderInput("lev4", NULL, min = 0, max = 10, value = 0,ticks=F),
                                     shiny::selectizeInput("feature_5", "Feature 5",choices =  colnames(Spotify)[10:20], multiple = F),
