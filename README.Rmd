...
Yet, you need input the `rank` variable which indicates the range of songs you want to plot. For example, if you want to plot the first 3 songs, you would input 1:3, and the values of their features' levels would be averaged. The example below only plots one songs and compared with the selections. Check example as following:        
